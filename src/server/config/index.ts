export class Config {
    ...
    public static LOCALTUNNEL_SUBDOMAIN: string = process.env.LOCALTUNNEL_SUBDOMAIN || "hockeyfanalytics";

    public static NHL_STATSAPI_ENDPOINT: string = "https://statsapi.web.nhl.com";
}